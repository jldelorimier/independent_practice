...
class Deck
  ...
  def deal_card_player
    random = rand(@playable_cards.size)
    p "random is #{random}"
    card_dealed = @playable_cards[random]
    p "the card dealed is #{card_dealed}"
    @dealer_hand << card_dealed
    @playable_cards.delete_at(random)
  end
  # def deal_card_dealer
  #   random = rand(@playable_cards.size)
  #   @player_hand << card.random
  #   @playable_cards.delete_at(random)
  # end
...
p deck
deck.deal_card_player
p player_hand
deck.deal_card_dealer
p dealer_hand